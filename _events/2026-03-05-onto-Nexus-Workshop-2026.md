...
tag: [MBSE, OML, openCAESAR]
categories: [blog]
image:
  feature: onto_Nexus_Workshop_2026.png
  credit: openCAESAR
permalink: /events/onto-Nexus-Workshop-2026
---
  ...
  <div class="row">
    <div class="col-12">
      ...
      <div style="border-radius: 15px; border: 1px solid #ccc; margin-bottom: 1rem; padding: 1rem;">
        ...
        <p/>
        <p>Co-located with <a href="https://conf.researchr.org/series/models"><strong>MODELS 2026</strong></a>.</p>
        <a href="https://conf.researchr.org/home/models-2026"><img width="100%" src="https://conf.researchr.org/getImage/models-2026/carousel/img-1-up-op.jpg"/></a>
      </div>
      ...
      <div style="border-radius: 15px; border: 1px solid #ccc; margin-bottom: 1rem; padding: 1rem;">
        ...
        <ul>
          <li>Ontological modeling methods and methodologies, analysis tools, and processes for model-based software or systems engineering</li>
          ...
          <li>AI for onto. modeling/analysis, and onto. modeling/analysis for AI</li>
      ...
      <div style="border-radius: 15px; border: 1px solid #ccc; margin-bottom: 1rem; padding: 1rem;">
        ...
        <p>Submit your paper via the onto:Nexus Workshop 2026
          <a href="https://easychair.org/conferences?conf=ontonexus2026" target="_blank" rel="noopener noreferrer">
             EasyChair
          </a> website.
        </p>
