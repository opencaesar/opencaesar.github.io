...
The openCAESAR project has released a v2 of OML, which affected its textual syntax, graphical notation, and API. In this page, we highlight the notable changes from v1. 
