...
1. Search and replace the symbol `:>` by the symbol `<`.

1. Search and replace the symbol `ci ` by the symbol `instance `.

1. Search and replace the symbol `ri ` by the symbol `relation instance `.
